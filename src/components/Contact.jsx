...
const Contact = () => {
  ...
  return (
    <>
      <div className={`${classes.Contacts} zoom-animation`}>
        <div className={`${classes.Contactcontainer} row container`}>
          <div className={`${classes.Servicescontent1} col-md-6`}>
            ...
            <div className={classes.address1}>
              ...
              <div className={classes.addresscontent}>
                ...
                <p className={classes.add1}>
                  No. 40, Rukmani Street, West Mambalam, Chennai, Tamil Nadu 600
                  033
                </p>
              </div>
            </div>
          ...
          <div className={`${classes.Servicescontent} col-md-6`}>
